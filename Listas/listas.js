    ...
    function calc2(){
        ...
        if(det==0){
            ...
            if(detx==0){
                ...
                div3.innerHTML='El determinante de la matriz es '+det+' y el determinante de x es '+detx+' por lo cual el sistema es consistente y tiene infitas soluciones';
                contenedor.appendChild(div3);
            }else{
                let div3=document.createElement("div");
                div3.innerHTML='El determinante de la matriz es '+det+' y el determinante de x es '+detx+' por lo cual el sistema es inconsistente y no tiene solución';
                contenedor.appendChild(div3);
            }
        } else {
            let div3=document.createElement("div");
...
function matriz3(){
    ...
    function calc3(){
        ...
        if(det==0){
            ...
            if(detx==0){             
            let div4=document.createElement("div");
            div4.innerHTML='El determinante de la matriz es '+det+' y el determinante de x es '+detx+' por lo cual el sistema es consistente y tiene infitas soluciones';
            contenedor.appendChild(div4);   
            }else{
               let div4=document.createElement("div");
               div4.innerHTML='El determinante de la matriz es '+det+' y el determinante de x es '+detx+' por lo cual el sistema es inconsistente y no tiene solución';
               contenedor.appendChild(div4);   
            }
        } else {
            let div4=document.createElement("div");
